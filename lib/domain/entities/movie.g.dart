...
void _movieSerialize(
  ...
  writer.writeDouble(offsets[12], object.voteAvarage);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    voteAvarage: reader.readDouble(offsets[12]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> voteAvarageEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'voteAvarage',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> voteAvarageGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> voteAvarageLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> voteAvarageBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByVoteAvarage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voteAvarage', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByVoteAvarageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voteAvarage', Sort.desc);
    });
  }
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByVoteAvarage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voteAvarage', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByVoteAvarageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voteAvarage', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByVoteAvarage() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'voteAvarage');
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, double, QQueryOperations> voteAvarageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'voteAvarage');
    });
  }
